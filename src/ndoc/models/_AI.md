...
> 最后更新 (Last Updated): 2026-02-26 20:35:02
...
*   **[context.py](context.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: .symbol, dataclasses, pathlib, typing
    *   `@API`
        *   `PUB:` CLS **Section**
            *   `VAL->` VAR **name**`: str`
            *   `VAL->` VAR **content**`: str`
...
*   **[scan.py](scan.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: .context, .symbol, dataclasses, typing
    *   `@API`
        *   `PUB:` CLS **TokenRule**
            *   `VAL->` VAR **name**`: str`
