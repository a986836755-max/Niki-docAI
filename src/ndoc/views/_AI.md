...
*   **[context.py](context.py#L1)**: View: Context Rendering. @DEP: src/ndoc/core/__init__.py, src/ndoc/interfaces/__init__.py, src/ndoc/models/context.py
    *   `@API`
...
*   **[header.py](header.py#L1)**: View: Header Injection. @DEP: src/ndoc/core/templates.py
    *   `@API`
...
*   **[reports.py](reports.py#L1)**: View: Report Tables. @DEP: src/ndoc/views/mermaid.py
    *   `@API`
...
*   **[status.py](status.py#L1)**: View: Status Reports. @DEP: src/ndoc/core/templates.py, src/ndoc/models/status.py
    *   `@API`
