...
*   **[__init__.py](__init__.py#L1)**: Atoms: AST Parsing (Tree-sitter Wrapper). @DEP: src/ndoc/parsing/ast/base.py, src/ndoc/parsing/ast/discovery.py, src/ndoc/parsing/ast/symbols.py, src/ndoc/parsing/ast/utils.py
    *   `@API`
        *   `VAL->` VAR __all__` = [
    'get_language', 'get_parser', 'parse_code', 'query_tre...`
*   **[base.py](base.py#L1)**: Atoms: AST Parsing Base. @DEP: src/ndoc/core/capabilities.py, src/ndoc/parsing/__init__.py
    *   `@API`
        *   `VAL->` VAR _LANGUAGES` = {}`
...
*   **[discovery.py](discovery.py#L1)**: Atoms: AST Symbol Discovery. @DEP: src/ndoc/parsing/__init__.py, src/ndoc/parsing/ast/base.py
    *   `@API`
...
*   **[skeleton.py](skeleton.py#L1)**: Atoms: Semantic Skeleton Generator. @DEP: src/ndoc/core/capabilities.py, src/ndoc/parsing/__init__.py, src/ndoc/parsing/ast/base.py
    *   `@API`
...
*   **[symbols.py](symbols.py#L1)**: Atoms: AST Symbol Extraction. @DEP: src/ndoc/core/text_utils.py, src/ndoc/models/symbol.py, src/ndoc/parsing/__init__.py, src/ndoc/parsing/ast/base.py, src/ndoc/parsing/ast/utils.py
    *   `@API`
        *   `PUB:` FUN **extract_symbols**`(tree: Tree, content_bytes: bytes, file_path: Optional[Path] = None) -> List[Symbol]`
*   **[utils.py](utils.py#L1)**: Atoms: AST Parsing Utilities. @DEP: src/ndoc/parsing/__init__.py, src/ndoc/parsing/ast/base.py
    *   `@API`
