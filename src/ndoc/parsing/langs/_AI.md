...
*   **[__init__.py](__init__.py#L1)**: Language Definition Protocol. @DEP: src/ndoc/core/text_utils.py
    *   `@API`
...
*   **[cpp.py](cpp.py#L1)** @DEP: src/ndoc/parsing/langs/__init__.py
    *   `@API`
...
"""`
            *   `PUB:` STA **is_public**`(name: str, visibility: str) -> bool`
*   **[csharp.py](csharp.py#L1)** @DEP: src/ndoc/parsing/langs/__init__.py
    *   `@API`
...
"""`
            *   `PUB:` STA **is_public**`(name: str, visibility: str) -> bool`
*   **[dart.py](dart.py#L1)** @DEP: src/ndoc/parsing/langs/__init__.py
    *   `@API`
...
*   **[go.py](go.py#L1)** @DEP: src/ndoc/parsing/langs/__init__.py
    *   `@API`
...
(type_declaration
  (type_spec
    name: (type_identifie...`
            *   `PUB:` STA **is_public**`(name: str, visibility: str) -> bool`
*   **[java.py](java.py#L1)** @DEP: src/ndoc/parsing/langs/__init__.py
    *   `@API`
...
(class_declaration
  ...
  name: (i...`
            *   `PUB:` STA **is_public**`(name: str, visibility: str) -> bool`
*   **[javascript.py](javascript.py#L1)** @DEP: src/ndoc/parsing/langs/__init__.py
    *   `@API`
...
(class_declaration
  name: (identifier) @name
            ...
            *   `PUB:` STA **is_public**`(name: str, visibility: str) -> bool`
*   **[python.py](python.py#L1)** @DEP: src/ndoc/core/text_utils.py, src/ndoc/parsing/langs/__init__.py
    *   `@API`
...
(import_stateme...`
            ...
            *   `PUB:` STA **extract_docstring**`(node: Any, content_bytes: bytes) -> Optional[str]`
            *   `PUB:` STA **format_signature**`(params_text: Optional[str], return_text: Optional[str]) -> str`
*   **[rust.py](rust.py#L1)** @DEP: src/ndoc/parsing/langs/__init__.py
    *   `@API`
...
(struct_item
  ...
  name...`
            *   `PUB:` STA **is_public**`(name: str, visibility: str) -> bool`
*   **[typescript.py](typescript.py#L1)** @DEP: src/ndoc/parsing/langs/__init__.py
    *   `@API`
