...
*   **[api_extractor.py](api_extractor.py#L1)**: Parsing: Dependency API Extractor. @DEP: src/ndoc/core/__init__.py, src/ndoc/models/config.py, src/ndoc/parsing/__init__.py, src/ndoc/parsing/deps/builder.py
    *   `@API`
        *   `PUB:` FUN **extract_related_apis**`(file_path: Path, config: ProjectConfig) -> str`
*   **[builder.py](builder.py#L1)**: Parsing: Dependency Graph Builder. @DEP: src/ndoc/core/__init__.py, src/ndoc/models/config.py, src/ndoc/parsing/__init__.py
    *   `@API`
...
*   **[core.py](core.py#L1)**: Core parsing logic for dependency manifests. @DEP: src/ndoc/core/__init__.py
    *   `@API`
...
*   **[stats.py](stats.py#L1)**: Language Statistics. @DEP: src/ndoc/core/__init__.py, src/ndoc/parsing/langs/__init__.py
    *   `@API`
        *   `PUB:` FUN **detect_languages**`(root: Path, ignore_patterns: Set[str]) -> Dict[str, float]`
*   **[test_mapper.py](test_mapper.py#L1)**: Deps: Test Usage Mapper. @DEP: src/ndoc/core/fs.py, src/ndoc/core/io.py, src/ndoc/models/config.py, src/ndoc/parsing/ast/__init__.py, src/ndoc/parsing/ast/discovery.py
    *   `@API`
