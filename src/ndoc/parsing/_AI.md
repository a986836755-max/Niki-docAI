...
*   **[extractors.py](extractors.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: src/ndoc/core/text_utils.py, src/ndoc/models/context.py, src/ndoc/models/scan.py, src/ndoc/models/symbol.py, src/ndoc/parsing/__init__.py, ...
    *   `@API`
...
*   **[rules.py](rules.py#L1)**: Parsing: Rule Extraction. @DEP: src/ndoc/core/__init__.py
    *   `@API`
...
*   **[scanner.py](scanner.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: src/ndoc/core/__init__.py, src/ndoc/core/capabilities.py, src/ndoc/models/context.py, src/ndoc/models/scan.py, src/ndoc/models/symbol.py, ...
    *   `@API`
...
*   **[universal.py](universal.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: src/ndoc/core/capabilities.py, src/ndoc/parsing/langs/__init__.py
    *   `@API`
        *   `VAL->` VAR _LANG_SPECS` = {}`
        *   `VAL->` VAR _EXT_MAP` = {}`
