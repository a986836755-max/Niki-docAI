...
*   **[__init__.py](__init__.py#L1)**: Interfaces: Entry Points. @DEP: src/ndoc/interfaces/lsp.py
*   **[lsp.py](lsp.py#L1)**: Atoms: Lightweight LSP-like features. @DEP: src/ndoc/core/__init__.py, src/ndoc/core/capabilities.py, src/ndoc/core/logger.py, src/ndoc/models/symbol.py, src/ndoc/parsing/__init__.py, ...
    *   `@API`
