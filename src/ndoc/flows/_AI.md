...
> 最后更新 (Last Updated): 2026-02-26 20:35:00
...
*   **[adr_flow.py](adr_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..models.config, ..parsing, collections, ...
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
*   **[arch_flow.py](arch_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ., ..core, ..core.cli, ..core.logger, ..core.templates, ...
    *   `@API`
        ...
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
*   **[archive_flow.py](archive_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..brain.vectordb, ..core, ..core.cli, ..models.config, ..parsing, ...
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
*   **[capability_flow.py](capability_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..models.config, ..parsing, pathlib, ...
    *   `@API`
...
*   **[check_flow.py](check_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..brain, ..core, ..core.cli, ..models.config, ..models.context, ...
    *   `@API`
...
*   **[clean_flow.py](clean_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ndoc.core.cli, ndoc.models.config, os, pathlib, typing
    *   `@API`
...
*   **[config_flow.py](config_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.templates, ..models.config, pathlib, re, ...
    *   `@API`
...
*   **[context_flow.py](context_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..brain, ..brain.vectordb, ..core, ..core.cli, ..core.logger, ...
    *   `@API`
...
*   **[data_flow.py](data_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..core.logger, ..models.config, ..models.context, ...
    *   `@API`
...
*   **[deps_flow.py](deps_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..core.logger, ..core.templates, ..models.config, ...
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig, target: str = None) -> bool`
*   **[doctor_flow.py](doctor_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.capabilities, ..core.cli, ..core.logger, ..core.templates, ...
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
...
*   **[impact_flow.py](impact_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..core.templates, ..models.config, ..parsing, ...
    *   `@API`
        ...
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
*   **[init_flow.py](init_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core.cli, ndoc.flows, ndoc.models.config
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig, force: bool = False) -> bool`
*   **[inject_flow.py](inject_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..core.logger, ..models.config, ..parsing, ...
    *   `@API`
        *   `PUB:` FUN **process_file**`(file_path: Path, root: Path) -> bool`
        *   `PUB:` FUN **run**`(config: ProjectConfig, target: str = None)`
*   **[lesson_flow.py](lesson_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..models.config, ..parsing, pathlib, ...
    *   `@API`
        *   `PUB:` FUN **run_check**`(config: ProjectConfig, target_files: List[str] = None) -> bool`
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
*   **[map_flow.py](map_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..core.templates, ..models.config, datetime
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
*   **[mind_flow.py](mind_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..models.config, ..parsing, collections, ...
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
*   **[prompt_flow.py](prompt_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..brain.vectordb, ..core, ..core.cli, ..core.templates, ..models.config, ...
    *   `@API`
...
*   **[quality_flow.py](quality_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core.cli, ..core.logger, ndoc.models.config, os, pathlib, ...
    *   `@API`
...
*   **[search_flow.py](search_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..brain.vectordb, ..core.cli, ..core.logger, ..models.config, pathlib, ...
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig, query: str, limit: int = 5) -> bool`
*   **[status_flow.py](status_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..core.logger, ..core.templates, ..models.config, ...
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig) -> bool`
*   **[syntax_flow.py](syntax_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.templates, ndoc.models.config, pathlib
    *   `@API`
        *   `PUB:` FUN **run**`(config: ProjectConfig, force: bool = False) -> bool`
*   **[update_flow.py](update_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..core.logger, pathlib, subprocess, ...
    *   `@API`
        *   `PRV:` FUN _is_git_repo`(path: Path) -> bool`
        *   `PUB:` FUN **run**`() -> bool`
*   **[verify_flow.py](verify_flow.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: ..core, ..core.cli, ..core.logger, ..parsing, ndoc.models.config, ...
    *   `@API`
