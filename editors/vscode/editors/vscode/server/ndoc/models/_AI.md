...
*   **[context.py](context.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: editors/vscode/editors/vscode/server/ndoc/models/symbol.py
    *   `@API`
        *   `PUB:` CLS **Section**
            *   `VAL->` VAR **name**`: str`
            *   `VAL->` VAR **content**`: str`
...
*   **[scan.py](scan.py#L1)**: <NIKI_AUTO_HEADER_START> @DEP: editors/vscode/editors/vscode/server/ndoc/models/context.py, editors/vscode/editors/vscode/server/ndoc/models/symbol.py
    *   `@API`
        *   `PUB:` CLS **TokenRule**
            *   `VAL->` VAR **name**`: str`
