...
*   **[__init__.py](__init__.py#L1)**: Niki-docAI Source Root. @DEP: editors/vscode/editors/vscode/server/ndoc/core/bootstrap.py
*   **[__main__.py](__main__.py#L1)** @DEP: src/ndoc/entry.py
*   **[api.py](api.py#L1)**: Public API: High-level interfaces for Agents and MCP Servers. @DEP: editors/vscode/editors/vscode/server/ndoc/flows/__init__.py, editors/vscode/editors/vscode/server/ndoc/models/config.py
    *   `@API`
        *   `PUB:` CLS **NdocAPI**
...
*   **[daemon.py](daemon.py#L1)**: Daemon: Live Context Watcher. @DEP: src/ndoc/brain/hippocampus.py, src/ndoc/core/logger.py, src/ndoc/flows/__init__.py, src/ndoc/interfaces/__init__.py, src/ndoc/models/config.py
    *   `@API`
