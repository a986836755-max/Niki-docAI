...
*   **src/**
    *   **ndoc/**
        ...
        *   **flows/**
            ...
            *   [`archive_flow.py`](src/ndoc/flows/archive_flow.py#L1) - *Flow: Project Archiving & Memory.*
            ...
            *   [`data_flow.py`](src/ndoc/flows/data_flow.py#L1) - *Flow: Data Registry Generation.*
            ...
            *   [`plan_flow.py`](src/ndoc/flows/plan_flow.py#L1) - *Flow: Project Planning.*
            *   [`stats_flow.py`](src/ndoc/flows/stats_flow.py#L1) - *Flow: Statistics.*
            *   [`symbols_flow.py`](src/ndoc/flows/symbols_flow.py#L1) - *Flow: Symbol Index Generation.*
